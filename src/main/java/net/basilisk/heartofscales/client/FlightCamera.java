...
/** Third-person camera distance while flying a dragon, read by CameraMixin. Kept here so the mixin stays a one-liner. */
public final class FlightCamera {
    public static double distanceMultiplier() {
        ...
        return player != null && player.getVehicle() instanceof DragonEntity dragon && dragon.isFlying()
