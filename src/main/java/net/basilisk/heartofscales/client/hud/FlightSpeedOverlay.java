 ...
 */
public final class FlightSpeedOverlay implements LayeredDraw.Layer {
    public static final ResourceLocation ID = ResourceLocation.fromNamespaceAndPath(HeartOfScales.MOD_ID, "flight_speed");
    ...
    public void render(GuiGraphics graphics, DeltaTracker deltaTracker) {
        ...
        int x = graphics.guiWidth() / 2 + HOTBAR_HALF_WIDTH + 8;
