...
public class DragonScreen extends AbstractContainerScreen<DragonMenu> {
    ...
    protected void renderBg(GuiGraphics graphics, float partialTick, int mouseX, int mouseY) {
        ...
        InventoryScreen.renderEntityInInventoryFollowsMouse(graphics, left + 26, top + 18, left + 78, top + 70,
                ENTITY_SCALE, ENTITY_Y_OFFSET, this.mouseX, this.mouseY, menu.getDragon());
    }
